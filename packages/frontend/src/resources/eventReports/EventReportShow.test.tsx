    ...
    victims: [
      {
        ...
        destinationFacility: { id: 'hosp-1', name: 'CHUC — Hospital Geral' },
      },
    ],
    inemSupportUnits: [],
    attachments: [],
        ...
        inemSupportUnits: [
          {
            ...
            facilityId: 'hosp-1',
            facility: { id: 'hosp-1', name: 'CHUC — Hospital Geral' },
          },
        ],
      }),
    );
          ...
          victims: [
            {
              ...
              age: 67,
              destinationKind: VictimDestinationKind.HOSPITAL,
              destinationFacilityId: 'h',
              destinationFacility: { id: 'h', name: 'CHUC' },
            },
            {
              id: 'b',
              position: 1,
