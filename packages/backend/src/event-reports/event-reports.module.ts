...
@Module({
  ...
  // shift label both need to know what hours a shift covered. `InventoryModule`
  // for `StockMovementsService`: submitting a report is what deducts stock.
  imports: [AvailabilityModule, GeographyModule, StorageModule, InventoryModule],
  providers: [
    EventReportsService,
